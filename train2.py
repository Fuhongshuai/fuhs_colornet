...
train_dir = current_dir+'/summary/'
filenames = sorted(glob.glob(train_dir+"/*.png"))
checkpoint_path = current_dir+'/checkpoints/'
...
def train_color_net():
    ...
    #saver.restore(sess, save_path + 'model_epoch4999950.ckpt')
        ...
        while not coord.should_stop():
            ...
            if step % 1 == 0:
                ...
                if step % 1000 == 0:
                    ...
                    plt.imsave("shuai1/" + str(step) + "_0.jpg", summary_image)

            if step % 1000 == 0:
                checkpoint_name = os.path.join(checkpoint_path, 'model_epoch' + str(step) + '.ckpt')
                saver.save(sess, checkpoint_name)
                print("Save ckpt right!")
